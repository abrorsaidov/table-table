...
import { addRow, removeLast, loading, stopLoading } from "../redux";
    ...
    <Formik
      ...
      onSubmit={(data) => {
        ...
        setTimeout(() => {
          ...
          addRow(
            data,
            rows.length === 0 ? 1 : parseInt(rows[rows.length - 1].id) + 1
          );
        }, 2000);
        console.log(data);
      }}
        ...
        return (
          <Form className={"form-wrapper"} onSubmit={handleSubmit}>
            ...
            <div className={"text gender"}>
              ...
              <Field name="gender" type="radio" value="male" as={Radio} />
              <label htmlFor="female">Female</label>
              <Field name="gender" type="radio" value="female" as={Radio} />
            </div>
...
const dispatch2Props = (dispatch) => {
  return {
    ...
    addRow: (data, id) => dispatch(addRow(data, id)),
  };
};

export default connect(state2Props, dispatch2Props)(Forms);
